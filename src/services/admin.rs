...
#[delete("/admin/load")]
pub async fn delete_smiley_data(
    req: HttpRequest,
    req_body: String,
    pool: web::Data<Pool<ConnectionManager<SqliteConnection>>>,
) -> impl Responder {
